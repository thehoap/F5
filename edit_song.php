...
<h2>Edit song</h2>
<label>Tên Bài Hát: <input type="text" value="<?php echo $row['title']; ?>" name="title"></label><br/>
<label>Thể Loại: <input type="text" value="<?php echo $row['category']; ?>" name="category"></label><br/>
